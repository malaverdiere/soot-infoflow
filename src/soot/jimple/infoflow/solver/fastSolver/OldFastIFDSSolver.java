...
/**
 * A solver for an {@link heros.IFDSTabulationProblem}. This solver is not based on the IDESolver
 * implementation in Heros for performance reasons.
 *
 * @param <N> The type of nodes in the interprocedural control-flow graph. Typically {@link soot.Unit}.
 * @param <D> The type of data-flow facts to be computed by the tabulation problem.
 * @param <M> The type of objects used to represent methods. Typically {@link soot.SootMethod}.
 * @param <I> The type of inter-procedural control-flow graph being used.
 * @see heros.IFDSTabulationProblem
 */
public class OldFastIFDSSolver<N,D,M,I extends InterproceduralCFG<N, M>> {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(OldFastIFDSSolver.class);
	 ...
	 */
	public OldFastIFDSSolver(IFDSTabulationProblem<N, D, M, I> tabulationProblem) {
		this(tabulationProblem, DEFAULT_CACHE_BUILDER);
	}

	/**
	 * Creates a solver for the given problem, constructing caches with the given {@link com.google.common.cache.CacheBuilder}. The solver must then be started by calling
	 * {@link #solve()}.
	 * @param flowFunctionCacheBuilder A valid {@link com.google.common.cache.CacheBuilder} or <code>null</code> if no caching is to be used for flow functions.
	 * @param edgeFunctionCacheBuilder A valid {@link com.google.common.cache.CacheBuilder} or <code>null</code> if no caching is to be used for edge functions.
	 */
	public OldFastIFDSSolver(IFDSTabulationProblem<N, D, M, I> tabulationProblem, @SuppressWarnings("rawtypes") CacheBuilder flowFunctionCacheBuilder) {
	 ...
	 *        (this value is not used within this implementation but may be useful for subclasses of {@link soot.jimple.infoflow.solver.fastSolver.OldFastIFDSSolver})

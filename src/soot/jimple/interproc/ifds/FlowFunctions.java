...
/**
 * Classes implementing this interface provide a range of flow functions used to
 * compute which D-type values are reachable along the program's control flow.
 * 
 * @param <N>

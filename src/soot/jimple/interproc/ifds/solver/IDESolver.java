 ...
 */
public class IDESolver<N,D,M,V> {
	 ...
	 * {@link #solve()}.
	 */
	public IDESolver(IDETabulationProblem<N,D,M,V> tabulationProblem) {
		this.icfg = tabulationProblem.interproceduralCFG();
		this.flowFunctions = new ZeroedFlowFunctions<N,D,M>(tabulationProblem.flowFunctions(), tabulationProblem.zeroValue());
...
//			System.err.println("XXX "+((SootMethod)icfg.getMethodOf(nHashN)).getSignature()+" "+nHashN+" "+nHashD);
		}
	}
